...
public class ChoosePhotoActivity extends Activity
{
	...
	*/	
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			{
				Toast.makeText(ChoosePhotoActivity.this, "你选择了" + position  + " 号红包", Toast.LENGTH_SHORT).show();
				System.out.println("你选择了" + flag+"类的 "+position + " 号红包，ID="+ClassGameDB.mImageIds[flag][position]);
