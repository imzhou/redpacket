...
public class ClassGameDB {
    ...
    //手机开始界面选择菜单
    public static final String[] menu = { "开始游戏", "设置红包", "最佳成绩", "游戏选项", "游戏帮助"};
    ...
    /**默认图片的路径*/ 
    public static final String orgImageID = String.valueOf(R.drawable.hb1);
   ...
   // public static final int GameSetDataFlag=1;
    ...
    public static final String gameSetData[] = 		{ orgImageID, 	"N", 		"N", 		"N", 		"Y", 	String.valueOf(rows), String.valueOf(columns), };
    //游戏设置信息数组的长度
